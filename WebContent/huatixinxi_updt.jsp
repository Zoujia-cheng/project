...
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
			<form action="updateHuatixinxi.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="20" colspan="2" background="images/table_header.gif">修改话题信息<input type="hidden" name="id" value="${huatixinxi.id}" /></td>
						</tr>
						...
						<script language="javascript">document.form1.huatimingcheng.value='${huatixinxi.huatimingcheng}';</script>	
					 </table>
			</form>
   </body>
</html>
