	...
	<body>
			<form action="updateDiaochaxuanxiang.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						...
						<script language="javascript">document.form1.biaoti.value='${diaochaxuanxiang.biaoti}';</script>	<script language="javascript">document.form1.xuanxiangA.value='${diaochaxuanxiang.xuanxiangA}';</script>	<script language="javascript">document.form1.xuanxiangB.value='${diaochaxuanxiang.xuanxiangB}';</script>	<script language="javascript">document.form1.xuanxiangC.value='${diaochaxuanxiang.xuanxiangC}';</script>	<script language="javascript">document.form1.daan.value='${diaochaxuanxiang.daan}';</script>	<script language="javascript">document.form1.diaochabianhao.value='${diaochaxuanxiang.diaochabianhao}';</script>	<script language="javascript">document.form1.gongsibianhao.value='${diaochaxuanxiang.gongsibianhao}';</script>	
					 </table>
			</form>
   </body>
</html>
