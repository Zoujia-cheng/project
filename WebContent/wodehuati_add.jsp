	...
	<body>
			<form action="addWodehuati.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="20" colspan="2" background="images/table_header.gif">添加我的话题</td>
						</tr>
						<tr ><td width="200">话题名称：</td><td><select name='huatimingcheng' id='huatimingcheng' style=' height:19px; border:solid 1px #000000; color:#666666'><%=connDbBean.hsggetoption("huatixinxi","huatimingcheng")%></select></td></tr>		<tr ><td width="200">用户昵称：</td><td><input name='yonghucheng' type='text' id='yonghucheng' onblur='checkform()' style='border:solid 1px #000000; color:#666666' value='<%=(String)request.getSession().getAttribute("username")%>' />&nbsp;*<label id='clabelyonghucheng' /></td></tr>		
