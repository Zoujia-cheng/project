	...
	<tr>
		<td ><table width="184"  border="0" cellpadding="0" cellspacing="0"  id="__01">
		 ...
		 <tr>
				...
				<table width="91%" border="0" align="center" cellpadding="0" cellspacing="0">
					...
					<tr>
					 <td width="36" height="22" align="center"><img src="images/hsg5.gif"></td>
					  <td ><a href="doUpdateGongsixinxi2.do" target="mainFrame">个人资料管理</a></td>
					</tr>
				  </table>
				 </td>
              </tr>
          ...
          <tr>
            <td><table id="__02" width="184" border="0" cellpadding="0" cellspacing="0">
              <tr onClick="show('2')" style="cursor:pointer;">
                <td width="184"  background="images/hsg4.gif"><table width="100%" height="26" border="0" cellpadding="0" cellspacing="0">
                   <tr>
                      <td width="14%"  height="25" align="center" valign="bottom">&nbsp;</td>
                      <td width="86%" height="25"><span class="STYLE3"><strong>调查信息</strong></span></td>
                    </tr>
                </table></td>
              </tr>
              <tr>
                <td width="184"  style="display:none"  id="show2">
				<table width="91%" border="0" align="center" cellpadding="0" cellspacing="0">
					...
					<tr>
					 <td width="36" height="22" align="center"><img src="images/hsg5.gif"></td>
					  <td ><a href="diaochaxinxiList2.do" target="mainFrame">调查查询</a></td>
					</tr>
					<tr>
					 <td width="36" height="22" align="center"><img src="images/hsg5.gif"></td>
					  <td ><a href="diaochaxuanxiangList2.do" target="mainFrame">调查选项查询</a></td>
					</tr>
				  </table>
				 </td>
              </tr>
