...
-->
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
				...
				<td>
					<table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
						<tr align="left" bgcolor="#F2FDFF">
							<td colspan="17" background="images/table_header.gif">调查信息列表</td>
						</tr>
					</table>
				</td>
			</tr>
			  ...
			  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
					...
					<tr align="right" bgcolor="#ebf0f7">
					  ...
					  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" >
						<tr align="left" >
							<td colspan="17">
								<form action="diaochaxinxiList.do" name="myform" method="post">
				...
				%>
                            <tr align="center" bgcolor="#FFFFFF">
                             ...
                             <td>${u.diaochabianhao}</td>    <td>${u.huatimingcheng}</td>    <td>${u.diaochamingcheng}</td>    <td>${u.canyurenshu}</td>    <td>${u.diaochazhi}</td>    <td>${u.zongzhi}</td>    <td>${u.gongsibianhao}</td>    <td align='center'>${u.issh=='0'?'否':'是'} <input type="button" value="审核" onclick="javascript:location.href='sh.jsp?id=${u.id}&yuan=${u.issh}&tablename=diaochaxinxi'"/></td>
                              <td align="center"> ${u.addtime } </td>
                              <td align="center">
	                              <a href="doUpdateDiaochaxinxi.do?id=${u.id }">编辑</a>  
	                              <a href="deleteDiaochaxinxi.do?id=${u.id }"   onclick="{if(confirm('确定要删除吗?')){return true;}return false;}">删除</a> 
                              	  <a href="diaochaxuanxiang_add.jsp?id=${u.id }"  >添加选项</a></br>
                              	  <a href="tb.jsp?diaochabianhao=${u.diaochabianhao }"  >查看表格</a>
		 ...
		 <c:if test="${page.page>1}">
              <a href="diaochaxinxiList.do?page=1" >首页</a>
             <a href="diaochaxinxiList.do?page=${page.page-1 }"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="diaochaxinxiList.do?page=${page.page+1 }">下一页</a>
			<a href="diaochaxinxiList.do?page=${page.totalPage }">末页</a>		    </c:if>		
	</c:if>
	</p>
