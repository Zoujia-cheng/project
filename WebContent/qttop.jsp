...
<div class="header">
    ...
    if((String)request.getSession().getAttribute("username")==null || (String)request.getSession().getAttribute("username")==""){
     %>
               <a href="userlog.jsp">用户登陆</a> | <a href="yonghuxinxiadd.jsp">用户注册</a>
				 <%
							}
				  else
				  {
		...
		<div class="wrap">
			<div class="nav">
				<ul>
					...
					<li id="m2" class="m">
						<h3><a  href="xwtzList.do?lb=站内新闻">站内新闻</a></h3>
						
					</li>
					
					<li id="m4" class="m"><h3><a href="dcxxList.do">问卷调查</a></h3></li>
					<li id="m4" class="m"><h3><a href="yonghuxinxiadd.jsp">用户注册</a></h3></li>
					<li id="m4" class="m"><h3><a href="wodehuatiadd.jsp">添加话题</a></h3></li>
					<li id="m4" class="m"><h3><a href="wdhtList.do">我的话题</a></h3></li>
					<li id="m2" class="m">
						<h3><a >在线留言</a></h3>
						<ul class="sub">
