...
-->
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
			  ...
			  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
					...
					<tr align="right" bgcolor="#ebf0f7">
					  ...
					  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" >
						<tr align="left" >
							<td colspan="17">
								<form action="diaochaxinxiList2.do" name="myform" method="post">
				...
				%>
                            <tr align="center" bgcolor="#FFFFFF">
                             ...
                             <td>${u.diaochabianhao}</td>    <td>${u.huatimingcheng}</td>    <td>${u.diaochamingcheng}</td>    <td>${u.canyurenshu}</td>    <td>${u.diaochazhi}</td>    <td>${u.zongzhi}</td>    <td>${u.gongsibianhao}</td>    <td align='center'>${u.issh} </td>
                              ...
                              <td align="center"><a href="doUpdateDiaochaxinxi.do?id=${u.id }">编辑</a>  <a href="deleteDiaochaxinxi.do?id=${u.id }"
		 ...
		 <c:if test="${page.page>1}">
              <a href="diaochaxinxiList2.do?page=1" >首页</a>
             <a href="diaochaxinxiList2.do?page=${page.page-1 }"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="diaochaxinxiList2.do?page=${page.page+1 }">下一页</a>
			<a href="diaochaxinxiList2.do?page=${page.totalPage }">末页</a>		    </c:if>		
	</c:if>
	</p>
