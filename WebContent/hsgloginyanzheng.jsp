...
<html>
 ...
 if(cx.equals("用户")){sql="select * from yonghuxinxi where yonghucheng='"+uid+"' and mima='"+pwd+"'";} if(cx.equals("公司")){sql="select * from gongsixinxi where gongsibianhao='"+uid+"' and mima='"+pwd+"'";} //quxanxiaxndexnglxu
